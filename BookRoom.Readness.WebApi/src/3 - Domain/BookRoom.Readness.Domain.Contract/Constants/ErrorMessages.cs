namespace BookRoom.Readness.Domain.Contract.Constants
{
    public class ErrorMessages
    {
        ...
        public class BookRoomMessages
        {
            ...
            public const string ROOM_UNAVAILABLE = "Choosed room is unavailable for selected period. Check below reservations confirmed for 3 next months.";
        }
    }
}
